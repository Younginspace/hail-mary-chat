        ...
        {phase === 'home' && (
          <div ref={homeRef} className="hero-panel">
            ...
            <div className="hero-release" aria-label={t('hero.releaseLabel', lang)}>
              ...
              <div className="hero-release-item">{t('hero.releaseFeature1', lang)}</div>
              <div className="hero-release-item">{t('hero.releaseFeature2', lang)}</div>
              <div className="hero-release-item">{t('hero.releaseFeature3', lang)}</div>
              <div className="hero-release-item">{t('hero.releaseFeature4', lang)}</div>
            </div>
